...
from monocle.tests.test_consumers import (ConsumerTestCase,
                                          HTMLConsumerTestCase,
                                          PrefetchTestCase)
...
from monocle.tests.test_signals import CacheSignalTestCase, ConsumerSignalTestCase
